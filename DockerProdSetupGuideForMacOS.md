...
```bash
    porter install fullstack_rems --param vsac_api_key=${vsav_api_key} --allow-docker-host-access --reference codexrems/fullstack_rems:REMSvlatest # Initial Installation needs to be from remote repository
...
```bash
    ...
    porter invoke fullstack_rems --action stop --param vsac_api_key=${vsav_api_key} --allow-docker-host-access --reference codexrems/fullstack_rems:REMSvlatest
```
...
```bash
    ...
    porter upgrade fullstack_rems --param vsac_api_key=${vsav_api_key} --allow-docker-host-access --reference codexrems/fullstack_rems:REMSvlatest # Pull and Update Invocation Image in addition to application images from remote repository and recreate containers
```
...
```bash
    ...
    Error: 1 error occurred:
      ...
      porter uninstall fullstack_rems --param vsac_api_key=${vsav_api_key} --allow-docker-host-access --reference codexrems/fullstack_rems:REMSvlatest
```
