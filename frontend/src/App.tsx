        ...
        <div className='App'> 
          <Container maxWidth='false'>
            <div className="containerg">
                ...
                { token ? (
                  <div className="links">
                      <Button variant="outlined" className="white-btn" onClick={() => handleClickOpen()}>Reset full DB</Button>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Resetting the rems admin database will delete any existing rems case information and completed questionnaires.
              </DialogContentText>
            </DialogContent>
            <DialogActions>
