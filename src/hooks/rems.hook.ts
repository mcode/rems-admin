  ...
  "2183126": [
      {
          ...
          "type": "absolute",
          "url": new URL("https://www.accessdata.fda.gov/drugsatfda_docs/rems/Turalio_2020_08_04_REMS_Full.pdf")
      },
      {
          "label": "Medication Guide",
          "type": "absolute",
          "url": new URL("https://daiichisankyo.us/prescribing-information-portlet/getPIContent?productName=Turalio_Med&inline=true")
      },
      {
          "label": "Patient Guide",
          "type": "absolute",
          "url": new URL("https://www.accessdata.fda.gov/drugsatfda_docs/rems/Turalio_2020_12_16_Patient_Guide.pdf")
      },
      {
          "label": "Patient Status Update Form",
          "appContext": "questionnaire=http://localhost:8090/fhir/r4/Questionnaire/TuralioRemsPatientStatus",
          "type": "smart",
          "url": new URL(config.smart.endpoint)
      },
      {
          "label": "Patient Enrollment Form",
          "appContext": "questionnaire=http://localhost:8090/fhir/r4/Questionnaire/TuralioRemsPatientEnrollment",
          "type": "smart",
          "url": new URL(config.smart.endpoint)
      }
  ],
  "6064": [
    {
      "label": "Documentation Requirements",
      "type": "absolute",
      "url": new URL("https://www.accessdata.fda.gov/drugsatfda_docs/rems/Isotretinoin_2021_10_8_REMS_Document.pdf")
    },
    {
      "label": "Fact Sheet",
      "type": "absolute",
      "url": new URL("https://www.accessdata.fda.gov/drugsatfda_docs/rems/Isotretinoin_2021_10_8_Fact_Sheet.pdf")
    },
    {
      "label": "Guide For Patients Who Can Get Pregnant",
      "type": "absolute",
      "url": new URL("https://www.accessdata.fda.gov/drugsatfda_docs/rems/Isotretinoin_2021_10_8_Guide_for_Patients_Who_Can_Get_pregnant.pdf")
    },
    {
      "label": "Contraceptive Counseling Guide",
      "type": "absolute",
      "url": new URL("https://www.accessdata.fda.gov/drugsatfda_docs/rems/Isotretinoin_2021_10_8_Contraception_Counseling_Guide.pdf")
    },
    {
      "label": "Patient Enrollment Form",
      "appContext": "questionnaire=http://localhost:8090/fhir/r4/Questionnaire/IPledgeRemsPatientEnrollment",
      "type": "smart",
      "url": new URL(config.smart.endpoint)
    }
  ],
  "1237051":[
    {
      "label": "Documentation Requirements",
      "type": "absolute",
      "url": new URL("https://www.accessdata.fda.gov/drugsatfda_docs/rems/TIRF_2022_08_17_REMS_Document.pdf")
    },
    {
      "label": "Patient Counseling Guide",
      "type": "absolute",
      "url": new URL("https://www.accessdata.fda.gov/drugsatfda_docs/rems/TIRF_2022_08_17_Patient_Counseling_Guide.pdf")
    },
    {
      "label": "Patient FAQ",
      "type": "absolute",
      "url": new URL("https://tirfstorageproduction.blob.core.windows.net/tirf-public/tirf-patientfaq-frequently-asked-questions.pdf?skoid=417a7522-f809-43c4-b6a8-6b192d44b69e&sktid=59fc620e-de8c-4745-abcc-18182d1bf20e&skt=2022-09-20T19%3A06%3A21Z&ske=2022-09-26T19%3A11%3A21Z&sks=b&skv=2020-04-08&sv=2020-04-08&st=2021-03-21T21%3A27%3A00Z&se=2031-03-21T23%3A59%3A59Z&sr=b&sp=rc&sig=owSGAoUBZuCtsLE41F2XC3o12x%2BG%2Bt5ogykOIt796es%3D")
    },
    {
      "label": "Patient Enrollment Form",
      "appContext": "questionnaire=http://localhost:8090/fhir/r4/Questionnaire/TIRFRemsPatientEnrollment",
      "type": "smart",
      "url": new URL(config.smart.endpoint)
    }
  ]
  ...
  try {
    ...
    if(medicationCode && medicationCode.code){
      ...
      if(returnCard){
        ...
        links.forEach((e) => {
          if(e.type == 'absolute'){ // no construction needed
            card.addLink(e)
          } else {
            // link is SMART
